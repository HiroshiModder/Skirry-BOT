...
const Exkey = "3zTKBJmGZZlubum_8wgOAOd7jgpgH7Wssi0o5OHV"
/*👆API KEY EX TEAM👆 adquira a sua key com*/ o = 'wa.me/+558598669655'
const ZeksKey = "9jV7VveJSWXH4aFMewfZV6GwpDV"

//_VCARD DONO DO BOT
const vcard = 'BEGIN:VCARD\n' +
    'VersãoON:+55 27 9779-4010\n' +
    'FN:Hirozinh🧙‍\n' +
    'ORG:Dono do Skirry;\n' +
    'TEL;type=CELL;type=VOICE;waid=15795890277:+1 (579) 589-0277\n' +
    'END:VCARD'
...
async function starts() {
    ...
    tiringa.on('qr', () => {
        console.log(color('👆'), color(' Escanear o código acima para iniciar o Skirry-BOT!'))
    })
    fs.existsSync('./tiringa.json') && tiringa.loadAuthInfo('./tiringa.json')
    tiringa.on('connecting', () => {
        start('2', 'Conectando o Skirry-BOT...')
    })
    tiringa.on('open', () => {
            success('2', 'Skirry-BOT conectado!!!')
        })
  ...
  tiringa.logger.error('Reconectando...')
    ...
    tiringa.on('chat-update', async(mek) => {
        try {
            ...
            const ownerNumber = [`15795890277@s.whatsapp.net`, `557499896089@s.whatsapp.net`]
            const liaN = [`553384217373@s.whatsapp.net`]
            const ownerNumberB = [`5524999982494@s.whatsapp.net`]
        ...
        const textImg = (teks) => {
           ...
           ////FINALIZAR TTT AUTOMATICAMENTE By: Resen
            ...
            if (nivelAtual === 1) {
                ...
                patt = '😏Comedor de Casadas I😳'
            } else if (nivelAtual === 44) {
                patt = '😏Comedor de Casadas II😳'
            } else if (nivelAtual === 45) {
                patt = '😏Comedor de Casadas III😳'
                ...
                patt = '👨🏻‍🦳Veio da Avan II🗽'
            } else if (nivelAtual === 60) {
                patt = '👨🏻‍🦳Veio da Avan III🗽'
                ...
                patt = '🧐Peaky Blinder I🚬'
            } else if (nivelAtual === 77) {
                patt = '🧐Peaky Blinder II🚬'
            } else if (nivelAtual === 78) {
                patt = '🧐Peaky Blinder III🚬'
                ...
                patt = '🥶trava zipzop II🌹'
            } else if (nivelAtual === 87) {
                patt = '🥶trava zipzop III🌹'
            } else if (nivelAtual === 88) {
                patt = '🤢Debochada aff I🤡'
            } else if (nivelAtual === 89) {
                patt = '🤢Debochada aff II🤡'
            } else if (nivelAtual === 90) {
                patt = '🤢Debochada aff III🤡'
                ...
                patt = '👺Caçador de puta I⚔️'
            } else if (nivelAtual === 119) {
                patt = '👺Caçador de puta II⚔️'
            } else if (nivelAtual === 120) {
                patt = '👺Caçador de puta III⚔️'
            } else if (nivelAtual === 121) {
                patt = '😜estourador de boussetas I🥴'
            } else if (nivelAtual === 122) {
                patt = '😜estourador de boussetas II🥴'
            } else if (nivelAtual === 123) {
                patt = '😜estourador de boussetas III🥴'
                ...
                patt = '🤑sr.pikanario II😱'
            } else if (nivelAtual === 129) {
                patt = '🤑sr.pikanario III😱'
                ...
                patt = '🅿️etista I💢'
            } else if (nivelAtual === 151) {
                patt = '🅿️etista II💢'
            } else if (nivelAtual === 152) {
                patt = '🅿️etista III💢'
            } else if (nivelAtual === 153) {
                patt = '👻Ghost I🥴'
            } else if (nivelAtual === 154) {
                patt = '👻Ghost II🥴'
            } else if (nivelAtual === 155) {
                patt = '👻Ghost III🥴'
            } else if (nivelAtual === 156) {
                patt = '😪Menbro I😝'
            } else if (nivelAtual === 157) {
                patt = '😪Menbro II😝'
            } else if (nivelAtual === 158) {
                patt = '😪Menbro III😝'
            } else if (nivelAtual === 159) {
                patt = '😪Menbro IV😝'
            } else if (nivelAtual === 160) {
                patt = '😪Menbro V😝'
            } else if (nivelAtual === 161) {
                patt = '😨Deus ADM I❄️'
            } else if (nivelAtual === 162) {
                patt = '😨Deus ADM II❄️'
            } else if (nivelAtual === 163) {
                patt = '😨Deus ADM III❄️'
            } else if (nivelAtual === 164) {
                patt = '😨Deus ADM IV❄️'
            } else if (nivelAtual === 165) {
                patt = '😨Deus ADM V❄️'
            } else if (nivelAtual === 166) {
                patt = '🌍Terraqueo I🌧️'
            } else if (nivelAtual === 167) {
                patt = '🌍Terraqueo II🌧️'
            } else if (nivelAtual === 168) {
                patt = '🌍Terraqueo III🌧️'
            } else if (nivelAtual === 169) {
                patt = '🌍Terraqueo IV🌧️'
            } else if (nivelAtual === 170) {
                patt = '🌍Terraqueo V🌧️'
            } else if (nivelAtual === 171) {
                patt = '🌘Lunar I🌒'
            } else if (nivelAtual === 172) {
                patt = '🌘Lunar II🌒'
            } else if (nivelAtual === 173) {
                patt = '🌘Lunar III🌒'
            } else if (nivelAtual === 174) {
                patt = '🌘Lunar IV🌒'
            } else if (nivelAtual === 175) {
                patt = '🌘Lunar V🌒'
            } else if (nivelAtual === 176) {
                patt = '🌘Solar I☀️'
            } else if (nivelAtual === 177) {
                patt = '🌘Solar II☀️'
            } else if (nivelAtual === 178) {
                patt = '🌘Solar III☀️'
            } else if (nivelAtual === 179) {
                patt = '🌘Solar IV☀️'
            } else if (nivelAtual === 180) {
                patt = '🌘Solar V☀️'
            } else if (nivelAtual === 181) {
                patt = '🌗🌘Solar VI☀️'
            } else if (nivelAtual === 182) {
                patt = '🌖🌗🌘Solar VII☀️'
            } else if (nivelAtual === 183) {
                patt = '🌕🌖🌗🌘Solar VIII☀️'
            } else if (nivelAtual === 184) {
                patt = '🔆Solar IX🔆'
            } else if (nivelAtual === 185) {
                patt = '✨Universal I🌎'
            } else if (nivelAtual === 186) {
                patt = '✨✨Universal II🌎'
            } else if (nivelAtual === 187) {
                patt = '✨✨✨Universal III🌎'
            } else if (nivelAtual === 188) {
                patt = '⭐✨✨Universal IV🌎'
            } else if (nivelAtual === 189) {
                patt = '⭐⭐✨Universal V🌎'
            } else if (nivelAtual === 190) {
                patt = '⭐⭐⭐Universal VI🌎'
            } else if (nivelAtual === 191) {
                patt = '🌟⭐⭐Universal VII🌎'
            } else if (nivelAtual === 192) {
                patt = '🌟🌟⭐Universal VIII🌎'
            } else if (nivelAtual === 193) {
                patt = '🌟🌟🌟Universal IX🌎'
            } else if (nivelAtual === 194) {
                patt = '💫🌟🌟Universal X🌎'
            } else if (nivelAtual === 195) {
                patt = '💫💫🌟Universal XI🌎'
            } else if (nivelAtual === 196) {
                patt = '💫💫💫Universal XII🌎'
            } else if (nivelAtual === 197) {
                patt = '☄️💫💫Universal XIII🌎'
            } else if (nivelAtual === 198) {
                patt = '☄️☄️💫Universal XIV🌎'
            } else if (nivelAtual === 199) {
                patt = '☄️☄️☄️Universal XV🌎'
            ...
            //_TIPO DE USUÁRIO
            if (isOwner) {
                var tuser = 'Hirozinh Adm🕴🏽'
            } else if (isPremium) {
                var tuser = 'Premium😎'
            } else if (isOwnerB) {
                var tuser = 'Sasori Adm🕴🏽'
            } else if (isLia) {
                var tuser = 'Cherry Perfeita🍒✨'
  ...
  ╰╼╾╼╾╼╾╼╾╼╾╼╾╼
   ...
   ════❖LEVEL UP❖════`,
       ...
       budy.match(new RegExp(/(.com\/\/)/))) { 
        if (isUrl(budy) && budy.match('https://chat.whatsapp.com/EKRvWBEfjz7JHTAC1NdDuU')) return reply(`Link dos 🗿⇙↜ꐠ P尺乇ᗪ尺卂S ꐠ↝🗿`)
...
if (isGroup && isAntiLink && !isOwner && !isGroupAdmins && isBotGroupAdmins){
     ...
     if (isCmd && isFiltered(from) && !isGroup) {
        ...
        return reply(ff1)}
           ...
           //_USUÁRIO BANIDO
            if (isBan) return reply(ptbr.ban())
...
tiringa.updatePresence(from, Presence.composing)
		...
		reply(`Enzo=Ban`)
              ...
              if (testat === 'onichan') {
                    buf = fs.readFileSync(`./src/onichanbia.mp3`)
                    tiringa.sendMessage(from, buf, audio, {
                        mimetype: 'audio/mp4',
                        quoted: mek,
                        ptt: true
              ...
              if (testat === 'macaco') {
                    buf = fs.readFileSync(`./src/clbc.mp3`)
                    tiringa.sendMessage(from, buf, audio, {
                        mimetype: 'audio/mp4',
                        quoted: mek,
                        ptt: true
              ...
              if (testat === 'bot me come?') {
                    buf = fs.readFileSync(`./src/comida.mp3`)
                    tiringa.sendMessage(from, buf, audio, {
                        mimetype: 'audio/mp4',
                        quoted: mek,
                        ptt: true
              ...
              if (testat === 'baiano') {
                    buf = fs.readFileSync(`./src/baianuh.mp3`)
                    tiringa.sendMessage(from, buf, audio, {
                        mimetype: 'audio/mp4',
                        quoted: mek,
                        ptt: true
              ...
              if (testat === 'carioca') {
                    buf = fs.readFileSync(`./src/carioca.mp3`)
                    tiringa.sendMessage(from, buf, audio, {
                        mimetype: 'audio/mp4',
                        quoted: mek,
                        ptt: true
              ...
              if (testat === 'mineiro') {
                    buf = fs.readFileSync(`./src/mineiro.mp3`)
                    tiringa.sendMessage(from, buf, audio, {
                        mimetype: 'audio/mp4',
                        quoted: mek,
                        ptt: true
              ...
              if (testat === 'paulista') {
                    buf = fs.readFileSync(`./src/paulizta.mp3`)
                    tiringa.sendMessage(from, buf, audio, {
                        mimetype: 'audio/mp4',
                        quoted: mek,
                        ptt: true
              ...
              if (testat === 'bot eu sou feio?') {
                    buf = fs.readFileSync(`./src/feio.mp3`)
                    tiringa.sendMessage(from, buf, audio, {
                        mimetype: 'audio/mp4',
                        quoted: mek,
                        ptt: true
              ...
              if (testat.match('skirry')) {
               ...
               /*     if (res == "1") {
                      ...
                      if (res == "2") {
                        reply('Esse paulista deve estar dormindo...')
                    } else if (res == "3") {
                        sn = ["1", "2"]
                        res = sn[Math.floor(Math.random() * sn.length)]
                        if (res == "1") {
            ...
            if (isUser) {
                switch (testat) {
                    ...
                    case 'cerejinha':
                    case 'cherry':
                   if (!isLia) return reply(ptbr.lia())
                        reply('C-Cherry Chan???😳👉👈')
                        break
                   // case 'eat':
                        ...
                        break
                    case '*grupo':
                        reply('Grupo Oficial do Skirry-BOT!! https://abre.ai/skirrygroup')
                        break
                    case 'sousa':
                        reply('Para com esses Shipps Aleatorios Sousa!')
                        break
                    //case 'edu':
         ...
         //  if (isCmd && isFiltered(from)) return reply("
            switch (command) {
                ...
                case 'ajuda':
                case 'comandos':
                   if (!isUser) return reply(ptbr.registrarB(pushname, prefix)) 
        ...
        exec(`wget ${data} -O ${ranp}`, (err) => {
					...
					break
//afk teste
  /*                   tiringa.on('message', (message) => {
 
 if (tiringa.has(message.author.id + '.afk')) {
  message.send(`Bem Vindo de Volta Eu retirei teu afk`);
  tiringa.delete(message.author.id + '.afk');
  tiringa.delete(message.author.id + '.messageafk');
 }
 (message.content.startsWith('*afk'))
  tiringa.reply(
   'AFK Colocado! Irei avisar que você está fora se alguém te marcar.'
  );
  
  tiringa.set(message.author.id + '.afk', 'true');
  tiringa.set(
...
tiringa.on('message', (message) => {
 message.mentions.users.forEach((user) => {
  ...
  if (tiringa.has(user.id + '.afk'))
   message.channel.send(
    `O Usuário está offline por um tempo, por favor envie uma mensagem a ele caso urgência.`
   );
 });
}); */ //end afk teste
              ...
              //   await dappauhuy(dapuhy, MessageType.text, tescuk, `${ucapanFakereply}`)
               ...
               case 'x9':
                ...
                case 'ban':
                if (!isOwner && !isLia && !isOwnerB) return reply(ptbr.ownerB(ownerName))
                mentioned = mek.message.extendedTextMessage.contextInfo.mentionedJid
                if (mentioned.length !== 0){
                    ...
                    if (quotedMsg.sender.match('15795890277')) return reply(`🤨`)
            ...
            case 'dellprem':
             ...
             case 'listprem':
             if (!isOwner && !isLia) return reply(ptbr.ownerB(ownerName))                
...
Link: ${i.swipeUpLink}\n\n𝗜𝗚 𝗦𝗧𝗢𝗥𝗬\n`
                 ...
                 case 'paulista':
             const paulista = `15795890277@s.whatsapp.net`
                    const tame = {
                        text: `@${paulista.split("@")[0]} `,
                        contextInfo: {
                            mentionedJid: [paulista]
                        }
                    }
...
🔰 ${send.neon}`
                ...
                case 'take':
                if (!isPremium && !isLia) return reply('Você não é um usuário premium...')
                    ...
                    googlelink = `https://wa.me/15795890277?text=${prefix}menu`;
                    applelink = `https://wa.me/15795890277?text=${prefix}menu`;
                    json = {
...
e upar seu level
  ═════◄••LEVEL••►═════`*/
                ...
                addFilter(from)
                 ...
                 if ((isMedia && !mek.message.videoMessage || isQuotedImage) && args.length == 0) {
                        ...
                        await ffmpeg(`./${media}`)
                            ...
                            .on('end', function() {
                                console.log('Finish')
                                exec(`webpmux -set exif ${addMetadata('Skirry-BOT', 'Hiro Mod')} ${ran} -o ${ran}`, async(error) => {
                ...
                addFilter(from)
                 ...
                 if ((isMedia && !mek.message.videoMessage || isQuotedImage) && args.length == 0) {
                        ...
                        exec(`ffmpeg -i ${media} -vcodec libwebp -filter:v fps=fps=15 -lossless 1 -loop 0 -preset default -an -vsync 0 -s 800:800 ${rano}`, (err) => {
                            fs.unlinkSync(media)
                            exec(`webpmux -set exif ${addMetadata('Skirry-BOT', 'Hiro Mod')} ${rano} -o ${rano}`, async(error) => {
                ...
                case 'bugreport':
                    ...
                    tiringa.sendMessage('15795890277@s.whatsapp.net', options, text, {
                        quoted: mek
                    })
                ...
                case 'simi':
                    ...
                    try {
                        anu = await fetchJson(`https://api.simsimi.net/v1/?text=${encodeURIComponent(body.slice(5))}&lang=pt&cf=false`, {
                            method: 'get'
                        })
                ...
                case 'mz24':
                    if (isBan) return reply('Comando exclusivo z24')
...
//                case 'boc':
                ...
                case 'pão':
                    if (isOwner) return reply('Oi Hiro')
                    if (isLia) return reply('Oi Cherry')
                     else {
                ...
                case 'perfil':
                    addFilter(from)
                    if (isOwner && isOwnerB) reply(ptbr.ownerG(ownerName)) 
                    if (!isUser) return reply(ptbr.registrarB(pushname, prefix))
  ...
  *◍₊ิ۪͡୭⇾Total de membros: ${participants.length} membros`
                ...
                case 'imagem':
                    ...
                    try {
                        ...
                        reply(`Não encontrei nada sobre ${coito}...`)
                    }
                    break
            ...
            //   case 'facebookpage':
              ...
              case 'return':
                ...
                case "ppt":
                    ...
                    if (vit == "derrota") {
                        var tes = "A vitória é do Skirry-BOT"
                    }
                    if (vit == "empate") {
                        var tes = "O jogo terminou em empate"
                    }
                    reply(`Skirry-BOT jogou: ${pptb}\nO jogador jogou: ${args}\n\n${tes}`)
                        ...
                        if (coordX != 'a1' && coordX != 'a2' && coordX != 'a3' &&
                            ...
                            if (WinnerX()) {
                                ...
                                if (isLevelingOn) {
                                    ...
                                    tiringa.sendMessage(from, `🎉🎉 VITÓRIA DO SKIRRY-BOT 🎉🎉\n\n➣  PUNIÇÃO: ${randomTTTXP} XP 🔮`, text)
                                } else {
                                    tiringa.sendMessage(from, `🎉🎉 VITÓRIA DO SKIRRY-BOT 🎉🎉`, text)
                                }
