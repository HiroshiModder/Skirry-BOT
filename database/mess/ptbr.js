...
exports.lia = () => {
	return`Só a myah pode usar😳👌`
}

exports.ownerB = (ownerName) => {
	return`O comando só pode ser usado pelo Hiroshi🕴`
}
...
exports.registrarB = (pushname, prefix) => {
	return`Olá ${pushname}\n\nVocê ainda não se registrou...\n\nPara se registrar e poder usar todos os comandos do bot, por favor use:\n\nComando: ${prefix}registrar seu nome|sua idade\nPor exemplo: ${prefix}registrar Hiroshi|13 Lembrando que a registrar, você concorda com os termos e a politica de privacidade: https://hiromod.webnode.com/skirryterms/`
}
